...
CREATE TABLE STUDENTS (
    ID_STUDENT INTEGER GENERATED ALWAYS AS IDENTITY(START WITH 1 INCREMENT BY 1) PRIMARY KEY,
...
CREATE TABLE COURSES (
    ID_COURSE INTEGER GENERATED ALWAYS AS IDENTITY(START WITH 1 INCREMENT BY 1) PRIMARY KEY,
    NAME VARCHAR(50) NOT NULL,
...
CREATE TABLE ASSIGNMENTS (
    ID_ASSIGNMENT INTEGER GENERATED ALWAYS AS IDENTITY(START WITH 1 INCREMENT BY 1) PRIMARY KEY,
